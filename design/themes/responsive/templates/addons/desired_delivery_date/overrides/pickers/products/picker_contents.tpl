    ...
    function _getDescription(obj, id) 
    {
        ...
        if (aoc.length && aoc.prop('checked')) {
            ...
            $(':input', $('#option_' + id + '_AOC')).each( function() {
                ...
                if ((op.type == 'text' || op.type == 'date' || op.type == 'textarea') && op.value != '') {
                ...
                if ((op.type == 'checkbox') || ((op.type == 'text' || op.type == 'date' || op.type == 'textarea') && op.value != '') || (op.type == 'select-one') || (op.type == 'radio' && op.checked == true)) {
                    if (op.type == 'checkbox') {
